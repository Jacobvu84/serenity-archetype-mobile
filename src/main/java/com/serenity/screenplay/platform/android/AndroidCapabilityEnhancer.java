...
public class AndroidCapabilityEnhancer implements BeforeAWebdriverScenario {
	...
	private final static String APP_PACKAGE_NAME = "jp.naver.line.android";
	private final static String APP_ACTIVITY_NAME = "jp.naver.line.android.activity.SplashActivity";
